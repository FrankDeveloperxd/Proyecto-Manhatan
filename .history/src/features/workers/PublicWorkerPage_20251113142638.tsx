          ...
          <Card title="Ubicación y Cómo llegar" icon="profile" delay="210ms">
            ...
            <div className="w-full h-64 rounded-xl overflow-hidden border">
              <iframe
                ...
                src={`https://www.google.com/maps/embed/v1/place?key=TU_API_KEY_AQUI&q=-16.409,-71.537`}
              ></iframe>
            </div>
            ...
            <div className="mt-3 space-y-3">
              <div className="text-slate-600 text-sm">
                Punto de referencia del trabajador.
              </div>
              ...
              <button
                onClick={() => {
                  ...
                  if (navigator.geolocation) {
                    ...
                    alert("El navegador no permite obtener ubicación GPS");
                  }
                }}
